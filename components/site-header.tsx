...
const links = [
  ...
  { href: "/james/1", label: "Commentary", active: (pathname: string) => pathname.startsWith("/james") },
...
export function SiteHeader() {
  ...
  return (
    <header className="reader-header no-print">
      <Link href="/" className="reader-brand" aria-label="James Commentary Home">
        ...
        <span className="reader-brand-text">
          <span className="reader-brand-strong">James Commentary</span>
        </span>
      </Link>
