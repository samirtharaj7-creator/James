const libraryItems = [
  ...
  { name: "James", description: "Living faith, wisdom, speech, patience, and prayer", href: "/", category: "book", current: true },
  ...
  { name: "Salvation", description: "Righteousness by faith, justification, and assurance", href: "https://salvation.mybibleexplorer.com/", category: "topic" },
...
export function GlobalShell() {
  return (
    <header className="mbe-global-shell" data-tool="james" data-embedded="true">
...
export function GlobalFooter() {
  return (
    <footer className="mbe-global-footer" data-tool="james">
